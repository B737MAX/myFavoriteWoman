const array = ["Почти месяц назад мы познакомились", 
                ...
                "и еще ты печёшь аппетитную выпечку )",
                "Я не думал что смогу что то чувствовать к кому нибудь, после определённых событий в моей жизни",
                "Но Ты постепенно заполняешь ту пустоту которая образовалась у меня внутри за последние годы",
                "У меня к тебе по настоящему тёплые чувства...",
                "И мне это нравится",
